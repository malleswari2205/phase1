...
function education(edu){
	...
	table.border="2";
	var tr1="<tr><th> degree</th><th> institute</th><th> per</th><th> year</th></tr>";
	var tr2="";
	for(var i=0;i<edu.length;i++){
		tr2=tr2+"<tr><td>"+edu[i].degree+"</td><td>"+edu[i].institute+"</td><td>"+edu[i].per+"</td><td>"+edu[i].year+"</td></tr>";
	}
